...
let PetitionResolver = class PetitionResolver {
    ...
    async getActivePetition(limit, location) {
        const region = location.country_name;
        return await this.petitionService.findAllActive(region);
    }
    async getActivePetitionOtherRegion(limit, location) {
        const region = location.country_name;
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], PetitionResolver.prototype, "getActivePetition", null);
__decorate([
    (0, graphql_1.Query)(),
    __param(0, (0, graphql_1.Args)('limit')),
    __param(1, (0, graphql_guard_1.locationGLQ)()),
    ...
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], PetitionResolver.prototype, "getActivePetitionOtherRegion", null);
__decorate([
