...
export declare class PetitionResolver {
    ...
    getActivePetition(limit: number, location: any): Promise<import("../schema/petition.schema").Petition[]>;
    getActivePetitionOtherRegion(limit: number, location: any): Promise<(region: string, limit?: number) => Promise<import("../schema/petition.schema").Petition[]>>;
